...
https://discord.gg/%s]],
	...
	roomSubscribeConfirm = "You will receive this room transcript in DMs when this room gets deleted",
	roomSubscribeConfirmStarted = "You will receive this room transcript in DMs when this room gets deleted. Transcript collection started now, so earlier events may be missing",
	roomLogConfirm = "Sent the current transcript to your DMs",
	roomLogConfirmStarted = "Sent the current transcript to your DMs. Transcript collection started now, so earlier events may be missing",
	roomLogEmpty = "There is no loggable content in this room yet",
	roomLogEmptyStarted = "Transcript collection started now. There is no loggable content to send yet",
	roomLogNoDM = "Bot was unable to DM you. Enable direct messages and try again",
	roomLogSendError = "Bot wasn't able to send transcript to your DMs. Please try again later",
