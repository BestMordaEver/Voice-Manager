...
**%d | %d** users]],
	...
	helpChoiceLobby1 = "lobby names and permissions",
	helpChoiceLobby2 = "lobby targeting",
	...
	lobbyTargetDesc = "Select a channel near which new rooms will be created",
	lobbyTargetTargetDesc = "A channel near which new rooms will be created",
	...
	lobbyGaps = "gaps",
	lobbyGapsDesc = "Choose if gaps left from deleted channels should be filled",
	lobbyGapsFill = "fill",
	lobbyGapsFillDesc = "Whether to fill the gaps",
	lobbyPosition = "position",
	lobbyPositionDesc = "Select where to create the channels relative to the target",
	lobbyPositionPositionDesc = "Select the position type",
	lobbyPositionAbove = "above",
	lobbyPositionBelow = "below",
	lobbyOrder = "order",
	lobbyOrderDesc = "Change which direction new channels stack",
	lobbyOrderOrderDesc = "Select the direction",
	lobbyOrderAscending = "ascending",
	lobbyOrderDescending = "descending",
	...
	resetLobbyTargetDesc = "Set new room target to lobby's category",
	...
	resetLobbyGapsDesc = "Disable the gap filling behavior",
	resetLobbyPositionDesc = "Reset the position to below target",
	resetLobbyOrderDesc = "Reset the order to descending",
